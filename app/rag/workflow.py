...
remote work, attendance, onboarding, performance, expenses, travel, conduct,
or employee support.
...
Rewrite this HR/employee-support question for better private
knowledge retrieval and public web search.
...
Clearly say this is external public information and may require
HR validation before being treated as company policy or
employment guidance.
...
def insufficient(state: AgentState):
    ...
    return {
        "answer": (
            ...
            "answer confidently. Please contact the HR team "
